...
class Settings:
    ...
    # SQLite Database for KCET data
    DATABASE_URL: str = os.getenv(
        "DATABASE_URL", str(BACKEND_DIR / "data" / "kcet_2024.db")
    )

    # PostgreSQL for users, sessions, messages
    ...
    # CORS Settings
    CORS_ORIGINS: List[str] = ["https://collegepathfinder.chetanr25.in","https://collegepathfinder.vercel.app", "http://localhost:3000", "http://localhost:5173"]
